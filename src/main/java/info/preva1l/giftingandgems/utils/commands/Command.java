package info.preva1l.giftingandgems.utils.commands;

import info.preva1l.giftingandgems.GiftingAndGems;
import info.preva1l.giftingandgems.config.Lang;
import info.preva1l.giftingandgems.utils.TaskManager;
...
public abstract class Command {
    ...
    public GiftingAndGems plugin;
    private CommandExecutor executor;
    private CommandArgs assigned;

    public Command() {
        this.plugin = GiftingAndGems.i();
        this.register();
    }
